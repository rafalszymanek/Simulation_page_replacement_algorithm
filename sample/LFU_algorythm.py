...
#         self.listOfPages[page].usePageLRU(self.attempt)
#         self.attempt += 1
#
...
#             if self.listOfPages[page].numberOfAttempt < minAtemptNumber:
#                 minAtemptNumber = self.listOfPages[page].numberOfAttempt
#                 indexPageToChange = i
#             elif self.listOfPages[page].numberOfAttempt == minAtemptNumber:
